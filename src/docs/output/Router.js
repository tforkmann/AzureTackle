...
export class Page extends Union {
    ...
    cases() {
        return ["Install", "Use", "QueryTable", "HandleNullValues", "ProvidingDefaultValues", "ParameterizedQuery", "InsertData"];
    }
}
...
export function PageModule_toUrlSegments(_arg) {
    switch (_arg.tag) {
        ...
        case 3:
            return PageModule_noQueryString(singleton("handlenullvalues"));
        case 4:
            return PageModule_noQueryString(singleton("providingdefaultvalues"));
        case 5:
            return PageModule_noQueryString(singleton("parameterizedquery"));
        case 6:
